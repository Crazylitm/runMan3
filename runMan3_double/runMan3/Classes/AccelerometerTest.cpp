...
//     m_fLastTime = fNow;
    ...
    else
    {
        ...
        //CCLOG("oldV=%f,CurV=%f,oldA=%f,CurA=%f",oldV,CurV,oldA,CurA);
            ...
            char msg[300];
            sprintf(msg, "latitude=%f&longitude=%f&spriteStyple=%d&spriteX=%f&spriteY=%f&id=%s&name=litm5",mygis.getLatitude(),mygis.getLongitude(),1,ptNext.x,ptNext.y,sPritelabel->getString());
            HttpGetTest(msg);
